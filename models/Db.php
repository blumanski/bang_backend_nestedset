...
Use \Bang\PdoWrapper, PDO, \Bang\Helper, Bang\Modules\Directory\Models\Mail;
...
class Db extends \Bang\SuperModel
{
     ...
     *            - array we want the count of
     * @param bool $reset
     *            - reset count for a fresh start
     */
    ...
    /**
     * Backup a category as .
     * sql file and upload the file to AWS S3
     * 
     * @param int $catid            
     */
    ...
    public function getMainTemplates()
    {
        ...
        if (is_array($files) && count($files)) {
            ...
            foreach ($files as $key => $value) {
                ...
                if (basename($value) != 'error.php' && basename($value) != 'login.php' && basename($value) != 'forgot.php' && basename($value) != 'message.php') {
